...
def biggest_cast
  ...
  #   .limit(1)
  #
  # Sometimes we need to use aggregate SQL functions 
  #   like COUNT, MAX, and AVG.
...
def directed_by_one_of(them)
  ...
  #
  # We can use IN to test if an element is present 
    # in an array.
  #
  ...
  #
  # Find the id and title of all the movies directed 
    # by one of 'them'.
    ...
    # .where(director_id: ['George Lucas', 'Steven Spielberg'])
end
...
def movie_names_before_1940
  ...
  #
  # Pluck works similarly to select, except that it converts
    #  a query result
  # directly into a Ruby Array instead of an ActiveRecord 
  #   object. This can
